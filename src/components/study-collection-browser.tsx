...
type LessonCard = { id: string; title: string; summary: string; tags: string[]; group: string; groupTitle: string; minutes: number; figure?: PublicFigure; videoId?: string; duration?: string; audio: boolean };
