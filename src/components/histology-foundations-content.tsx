...
export function HistologyFoundationsContent({ lesson }: { lesson: LibraryLesson }) {
  ...
  return <div className={styles.lesson}>
    <section className="study-panel" aria-labelledby="lesson-objectives">
      ...
      <p>No previous histology lesson is required. Review <Link href="/learn/foundations/histology">histology terminology</Link> if needed.</p>
    </section>
    <TissueFamilyOverview/>
    <section className="concept-explanations" aria-labelledby="concept-map-title">
      <h2 id="concept-map-title">Guided Explanation</h2>
      <p>Study the tissue families in sequence, then compare the evidence used to identify them. Each explanation can be expanded or collapsed.</p>
    ...
    <section aria-labelledby="knowledge-check-heading">
      ...
      <ConceptCheck lesson={lesson} title="Question 1: tissue families"/>
    ...
    <section aria-labelledby="application-heading" id="apply-the-concept">
      ...
      <p>Use the structural evidence to predict function or justify a classification. Each hypothetical scenario has one best answer.</p>
    ...
    <section className="study-panel" aria-labelledby="summary-checklist-title">
      ...
      <p>Continue with <Link href="/library/microscopy">microscopy and section interpretation</Link>, or revisit a tissue family from the related lessons.</p>
    </section>
  </div>;
}
