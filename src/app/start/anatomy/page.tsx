...
export default function AnatomyStart() {
  ...
  <p><Link className="text-link" href="/library/anatomy-foundations">Study the full Anatomy Foundations lesson, diagrams and questions →</Link></p>
  <Link className="button button-primary" href="/library/thoracic-cage-landmarks">Next: identify thoracic cage landmarks →</Link></article>;
}
