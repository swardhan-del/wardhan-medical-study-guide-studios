import { StarterPackDownload } from "@/components/starter-pack-download";
...
export default function StarterPackPage() {
  return <article className="site-container revision-page starter-pack">
    ...
    <nav aria-label="Starter pack actions" className="action-row print-control"><Link href="/start">Choose a subject</Link><StarterPackDownload /><PrintStudy label="Print / Save starter pack as PDF" /><Link href="/library">Return to library</Link></nav>
