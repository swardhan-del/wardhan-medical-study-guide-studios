...
export default async function RevisionPage({ params }: Props) {
 ...
 const refs = references as Record<string, { title: string; url: string; supportingIds?: string[] }>;
