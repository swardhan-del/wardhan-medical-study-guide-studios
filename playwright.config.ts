  ...
  projects: [
    {
      name: "desktop",
      testMatch:
        /(?:membership-pilot|security|printable-guides|resource-access|biophysics|first-visit|figures|public|student-audit|learning-continuity|directory|authored-guides|histology-resources|thorax|study-depth)\.spec\.ts/,
      use: {
