  ...
  projects: [
    {
      name: "desktop",
      testMatch:
        /(?:security|printable-guides|resource-access|biophysics|first-visit|figures|public|student-audit|learning-continuity|directory|authored-guides|subject-learning-paths|anatomy-foundations|histology-resources|thorax|study-depth)\.spec\.ts/,
      use: {
