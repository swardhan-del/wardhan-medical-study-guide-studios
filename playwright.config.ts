  ...
  projects: [
    {
      name: "desktop",
      testMatch:
        /(?:visual-learning|security|printable-guides|resource-access|biophysics|first-visit|figures|public|student-audit|learning-continuity|directory|authored-guides|anatomy-foundations|histology-resources|thorax|study-depth)\.spec\.ts/,
      use: {
