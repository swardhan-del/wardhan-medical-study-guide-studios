# 23. Popliteal fossa and neurovascular depth

Volume 5 · 10 minutes · Updated 2026-09-10

The artery lies deepest against the fossa floor, while the tibial nerve is most superficial in the central bundle.

## Objectives

- Describe the location and organization of popliteal fossa and neurovascular depth.
- Answer with anatomical reasons: What is the typical superficial-to-deep order of the central popliteal bundle?
- Draw the fossa boundaries and stack nerve, vein and artery from superficial to deep; add common fibular nerve along the lateral edge.

## Prerequisite knowledge

Start with anatomical position, planes, directional terms and the difference between a nerve, artery, vein and duct.
- Previous lesson: [knee-joint-mechanics](/library/knee-joint-mechanics)

## Popliteal Fossa

The popliteal fossa is the posterior knee diamond. Its main contents from superficial to deep are tibial nerve, popliteal vein, and popliteal artery.

## Relationships and functional organization

Superolateral boundary: biceps femoris. Superomedial boundary: semimembranosus and semitendinosus. Inferolateral boundary: lateral head of gastrocnemius. Inferomedial boundary: medial head of gastrocnemius. Floor: femur, posterior capsule, popliteus. Also contains common fibular nerve laterally, small saphenous vein termination, popliteal lymph nodes, and fat.

## Why can the common fibular nerve be affected near the fibular neck rather than centrally in the fossa?
...
- The artery lies deepest against the fossa floor, while the tibial nerve is most superficial in the central bundle.
- The common fibular nerve follows the lateral boundary toward the fibular neck rather than remaining central.

## Practice

### 1. What is the typical superficial-to-deep order of the central popliteal bundle?

A. Tibial nerve, popliteal vein, popliteal artery
B. Artery, nerve, vein
C. Vein, artery, nerve

### 2. Why can the common fibular nerve be affected near the fibular neck rather than centrally in the fossa?

Explain the mechanism

### 3. In popliteal fossa and neurovascular depth, which structural relationships help distinguish the main parts or pathways? Explain them in anatomical order.

Relationship recall

### 4. A learner answers “Artery, nerve, vein” to the question “What is the typical superficial-to-deep order of the central popliteal bundle?” Explain what needs correcting.

Correct a misconception

### 5. Draw the fossa boundaries and stack nerve, vein and artery from superficial to deep; add common fibular nerve along the lateral edge.
...
3. Superolateral boundary: biceps femoris. Superomedial boundary: semimembranosus and semitendinosus. Inferolateral boundary: lateral head of gastrocnemius. Inferomedial boundary: medial head of gastrocnemius. Floor: femur, posterior capsule, popliteus. Also contains common fibular nerve laterally, small saphenous vein termination, popliteal lymph nodes, and fat.
...
Source: anatomy-divided-volume-5, 32. Popliteal Fossa.
...
Website: /library/popliteal-fossa
